...
router.get('/specifications/:id/project_connector', authMiddleware, specificationsController.getProjectConnector);
router.post('/specifications/:id/project_connector', authMiddleware, specificationsController.createProjectConnector);
router.put('/specifications/:id/project_connector', authMiddleware, specificationsController.updateProjectConnector);
router.delete('/specifications/:id/project_connector', authMiddleware, specificationsController.deleteProjectConnector);
