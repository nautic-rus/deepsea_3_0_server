...
router.delete('/issues/:id/watchers', authMiddleware, issuesController.removeWatcher);
...
router.delete('/customer_questions/:id/watchers', authMiddleware, customerQuestionsController.removeWatcher);
...
router.delete('/documents/:id/watchers', authMiddleware, documentsController.removeWatcher);
...
router.get('/specifications_source_connectors', authMiddleware, specificationsController.listSourceConnectors);
router.get('/specifications_project_connectors', authMiddleware, specificationsController.listProjectConnectors);
router.get('/specifications_project_connectors/:id', authMiddleware, specificationsController.getProjectConnector);
router.post('/specifications_project_connectors', authMiddleware, specificationsController.createProjectConnector);
router.put('/specifications_project_connectors/:id', authMiddleware, specificationsController.updateProjectConnector);
router.delete('/specifications_project_connectors/:id', authMiddleware, specificationsController.deleteProjectConnector);
...
router.get('/specification_versions/:id/compare', authMiddleware, specificationVersionsController.compare);
...
// POST /api/storage - create storage DB record using explicit metadata only
