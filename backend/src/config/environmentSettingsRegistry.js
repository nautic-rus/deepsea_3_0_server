const definitions = [
  ...
  { key: 'JWT_SECRET', valueType: 'string', description: 'Секрет подписи access JWT', isSecret: true, requiresRestart: false },
  ...
  { key: 'OIDC_ISSUER_URL', valueType: 'string', defaultValue: '', description: 'Публичный issuer URL для OIDC discovery и JWT', isSecret: false, requiresRestart: false },
  { key: 'OIDC_CLIENT_ID', valueType: 'string', defaultValue: 'matrix', description: 'Client ID для Matrix OIDC login', isSecret: false, requiresRestart: false },
  { key: 'OIDC_CLIENT_SECRET', valueType: 'string', defaultValue: '', description: 'Client secret для confidential OIDC client (если используется)', isSecret: true, requiresRestart: false },
  { key: 'OIDC_CLIENT_NAME', valueType: 'string', defaultValue: 'Matrix', description: 'Человекочитаемое имя OIDC клиента', isSecret: false, requiresRestart: false },
  { key: 'OIDC_REDIRECT_URIS', valueType: 'string', defaultValue: '', description: 'Список разрешённых redirect_uri, разделённый запятыми или переводами строк', isSecret: false, requiresRestart: false },
  { key: 'OIDC_PRIVATE_KEY_PEM', valueType: 'string', defaultValue: '', description: 'RSA private key PEM для подписи ID token и access token', isSecret: true, requiresRestart: false },
