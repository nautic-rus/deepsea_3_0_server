...
### DELETE /api/links/{id}
**Описание:** Удаляет связь по ID.

**Требования:**
- Разрешение: `links.delete`

**Параметры:**
- `id` (path, integer) — ID связи
...
**Требования:**
- Разрешение: `issue-statuses.view`
...
**Требования:**
- Разрешение: `document-directories.view`
...
**Требования:**
- Разрешение: `document-directories.create`
...
**Требования:**
- Разрешение: `document-statuses.view`
...
**Требования:**
- Разрешение: `customer-questions.view`
...
**Требования:**
- Разрешение: `customer-questions.create`
...
**Требования:**
- Разрешение: `customer-questions.update`
...
**Требования:**
- Разрешение: `customer-question-statuses.view`
...
**Требования:**
- Разрешение: `material-categories.view`
...
**Требования:**
- Разрешение: `material-directories.view`
...
**Требования:**
- Разрешение: `specifications.view`
...
**Требования:**
- Разрешение: `specifications.create`
...
**Требования:**
- Разрешение: `specifications.update`
...
**Требования:**
- Разрешение: `specifications.delete`
...
**Требования:**
- Разрешение: `storage.create`

**Описание:** Загрузка файла в локальное хранилище. Принимает multipart/form-data с полем `file`. Можно дополнительно указать `subdir` — подпапку внутри локальной папки uploads.

**Запрос:** multipart/form-data
- `file` (file) — обязательное
- `subdir` (string) — необязательное
...
**Описание:** Загрузка файла в S3-хранилище. Принимает multipart/form-data с полем `file`. Можно указать `bucket_name` для переопределения bucket (если поддерживается конфигурацией).

**Запрос:** multipart/form-data
- `file` (file) — обязательное
- `bucket_name` (string) — необязательное
...
**Требования:**
- Разрешение: `file-categories.view`
...
**Требования:**
- Разрешение: `notifications.update`
...
**Требования:**
- Разрешение: `specializations.view`
...
**Требования:**
- Разрешение: `specializations.create`
...
**Требования:**
- Разрешение: `specializations.update`
...
**Требования:**
- Разрешение: `specializations.delete`
